# Appunti Capitolo 4
Il capitolo 4 del libro descrive due macro-categorie di esperimenti progettati per dimostrare un concetto fondamentale nella teoria delle code: **a parità di medie e di utilizzo del sistema, cambiare la varianza delle distribuzioni di probabilità modifica drasticamente i tempi di attesa e di risposta**.
...
## La conclusione chiave per il progetto

Il risultato principale di questi esperimenti è che **conoscere solo la media degli arrivi o l'utilizzo del server non basta per prevedere i tempi di risposta**.
