 ...
 * <li>Servizio in Q1: esponenziale con media
 * {@code 2 * meanServiceQ1Closed}</li>
...
public class MixedNetworkConfig {
    ...
    private final double routingProbabilityQ1; // p1 routing
     ...
     * @param maxCompletions      completamenti totali Q1 (chiusi+aperti) come
     *                            criterio di stop
     * @param openHyperP          parametro p dell'iperesponenziale inter-arrivo (0
     *                            < p < 1)
    ...
    public MixedNetworkConfig(int numCustomers,
        ...
        if (routingProbabilityQ1 < 0 || routingProbabilityQ1 > 1)
            throw new IllegalArgumentException("routingProbabilityQ1 must be in [0,1]");
        if (maxCompletions < 1)
    ...
    public double getMeanThinkTime() {
        return meanThinkTime;
    }

    public double getMeanServiceQ1Closed() {
        return meanServiceQ1Closed;
    }

    public double getMeanServiceQ2() {
        return meanServiceQ2;
    }

    public double getRoutingProbabilityQ1() {
        return routingProbabilityQ1;
    }

    public long getMaxCompletions() {
        return maxCompletions;
    }

    // ---- Getters classe aperta ----
    public double getOpenHyperP() {
        return openHyperP;
    }

    public double getOpenMeanArr1() {
        return openMeanArr1;
    }

    public double getOpenMeanArr2() {
        return openMeanArr2;
    }
