...
class ClosedNetworkConfigTest {
    ...
    void testValidConfig() {
        assertDoesNotThrow(() ->
            new ClosedNetworkConfig(10, 5.0, 1.0, 0.8, 10000));
    }
    ...
    void testInvalidNumCustomers() {
        assertThrows(IllegalArgumentException.class, () ->
            new ClosedNetworkConfig(0, 5.0, 1.0, 0.8, 10000));
    }
    ...
    void testInvalidThinkTime() {
        assertThrows(IllegalArgumentException.class, () ->
            new ClosedNetworkConfig(10, 0.0, 1.0, 0.8, 10000));
    }
    ...
    void testInvalidServiceQ2() {
        assertThrows(IllegalArgumentException.class, () ->
            new ClosedNetworkConfig(10, 5.0, 1.0, 0.0, 10000));
    }
    ...
    void testInvalidMaxCompletions() {
        assertThrows(IllegalArgumentException.class, () ->
            new ClosedNetworkConfig(10, 5.0, 1.0, 0.8, 0));
    }

    @Test
    @DisplayName("Getters restituiscono i valori corretti")
    void testGetters() {
        ClosedNetworkConfig c = new ClosedNetworkConfig(10, 5.0, 1.0, 0.8, 20000);
    ...
    void testSaturationBoundBottleneckQ1() {
        ...
        // X*(N) = min(1/1.0, N/11.8)
        // Per N=5: min(1.0, 5/11.8) = 5/11.8 ≈ 0.4237 → domina D_sum
        // Per N=30: min(1.0, 30/11.8) = 1.0 → domina bottleneck
        ClosedNetworkConfig c5  = new ClosedNetworkConfig(5,  10.0, 1.0, 0.8, 10000);
        ClosedNetworkConfig c30 = new ClosedNetworkConfig(30, 10.0, 1.0, 0.8, 10000);

        assertEquals(5.0 / 11.8, c5.getSaturationThroughputBound(),  1e-6);
        assertEquals(1.0 / 1.0,  c30.getSaturationThroughputBound(), 1e-6);
    }
}
